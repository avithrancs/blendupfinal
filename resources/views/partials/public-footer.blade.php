    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-300">
                    <li><a class="hover:text-white" href="{{ route('home') }}#catalog">Menu</a></li>
                    <li><a class="hover:text-white" href="{{ route('home') }}">About Us</a></li>
        ...
        <div class="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-300">
                <a class="hover:text-white" href="{{ route('home') }}#catalog">Menu</a>
                <a class="hover:text-white" href="#">Cart</a>
                @auth
